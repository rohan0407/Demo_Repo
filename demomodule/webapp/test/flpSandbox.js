		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Demo App",
									"targetURL": "#commaventicdemomodule-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"commaventicdemomodule-display": {
								"semanticObject": "commaventicdemomodule",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.maventic.demomodule",
									"url": sap.ui.require.toUrl("com/maventic/demomodule")
								}
							}
						}
					}
